...
use Instana\RobotShop\Ratings\Service\catalougeService;
...
class RatingsApiController implements LoggerAwareInterface
{
    ...
    /**
     * @var catalougeService
     */
    private $catalougeService;

    public function __construct(catalougeService $catalougeService, RatingsService $ratingsService)
    {
    ...
    public function put(Request $request, string $sku, int $score): Response
    {
        ...
        try {
            if (false === $this->catalougeService->checkSKU($sku)) {
